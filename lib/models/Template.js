...
// Relative, not "@/lib/templates" — this model is also imported directly by
// scripts/generateTemplateClassScan.mjs (plain Node ESM via the predev
// script), which doesn't resolve the "@/" alias the way Next's webpack
// build does.
...
const templateSchema = new mongoose.Schema(
  {
    ...
    // Unset (undefined) on existing templates until an admin tags them —
    // the gallery's category pills only match templates that have one set,
    // "All Templates" always shows everything regardless.
