...
// Demo content for Template 3's fallback preview (used only if the static
// thumbnail image at /templates/template-3.png fails to load).
export const sampleResume3 = {
