...
// Exact port of platform-fe's components/components/ui/dropdown-menu.tsx
// (a thin styled wrapper over @radix-ui/react-dropdown-menu) — TypeScript
// generics/types stripped, forwardRef calls and class names unchanged. The
// slate-* colors here are Tailwind's standard palette (not custom tokens),
// so they work in resume-builder with no token mapping needed.
